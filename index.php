...
<div class="container">
    <div class="jumbotron mt-2">
        <h1 class="display-4">Alaaddin Adworks Challenge</h1>
        <p class="lead">Simple, discount code publishing platform.</p>
        <hr class="my-4">
        <p>Click the button to access the project on github.</p>
        <a class="btn btn-primary btn-lg" href="#" role="button">GitHub - readme</a>
    </div>
        ...
        <div class="discount-code-box">
            <div class="row no-gutters justify-content-between">
                ...
                <div class="col-md-6 discount-code-title">
                    <h4>Yeni kullanıcılar için geçerli tüm alışverişlerde 15% indirim</h4>
                </div>
