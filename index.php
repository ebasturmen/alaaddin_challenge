                ...
                <div class="row no-gutters justify-content-between">
                    ...
                    <div class="col-md-2 discount-code-button">
                        <?php if (isset($_SESSION['logged_in'])) { ?>
                            ...
                            <input type="hidden" name="index_title" id="index_title"
                                   value="<?php echo $coupon['title'] ?>">
                            <button type="button" class="btn btn-primary btn-lg btn-block coupon-button"
                                    data-toggle="modal" data-target="#take-coupon-modal">Kodu Alın
                            </button>
                        <?php } else { ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="take-coupon-form">
                        ...
                        <button type="submit" class="btn btn-warning btn-lg btn-block mt-5 mb-2">İndirim kuponunu alın
                        </button>
                    </form>
                </div>
